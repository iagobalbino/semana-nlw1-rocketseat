...
import api from '../../services/api'; // olhe a sua api.ts e veja de onde vem os dados da api
...
const Detail = () => {
    ...
    useEffect(() => {}, []); // Parei aqui
    useEffect(() => {}, []); // Parei aqui (deletar)
    ...
    return (
      ...
      <View style={styles.container}>
          ...
          <Text style={styles.pointName}>Mercadão do Iago</Text>
